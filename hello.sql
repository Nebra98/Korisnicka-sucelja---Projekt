...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2021 at 01:31 PM
...
--
-- Table structure for table `kupljeni_albums`
--

CREATE TABLE `kupljeni_albums` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
...
(79, '2021_01_21_100045_create_kupljeni_albumi_table', 3);
...
--
-- Indexes for table `kupljeni_albums`
--
ALTER TABLE `kupljeni_albums`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kupljenialbum_album_id_foreign` (`album_id`),
  ADD KEY `kupljenialbum_user_id_index` (`user_id`);
...
--
-- AUTO_INCREMENT for table `kupljeni_albums`
--
ALTER TABLE `kupljeni_albums`
...
--
-- Constraints for table `kupljeni_albums`
--
ALTER TABLE `kupljeni_albums`
  ADD CONSTRAINT `kupljenialbum_album_id_foreign` FOREIGN KEY (`album_id`) REFERENCES `albums` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `kupljenialbum_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
