...
class ProfilesController extends Controller
{
    ...
    public function show($user_id)
    {
        ...
        $kupljeni = KupljeniAlbum::all();
        $albumss = Album::all();

        return view('UserProfile.profile')->with('user', $user)->with('albums', $albums)->with('photos', $photos)->with('kupljeni', $kupljeni)->with('albumss', $albumss);
    }
