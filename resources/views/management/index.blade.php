                                ...
                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="{{ route('photos.destroy', $photo, $user, 0) }}" method="POST" class="float-left">
                                                                @csrf
                                                                {{ method_field('DELETE') }}
                                                                <button type="submit" onclick="return confirm('Jeste li sigurni da želite izbrisati  pjesmu {{$photo->songName}}?')" class="btn btn-warning">Izbriši pjesmu</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                    ...
                                    <td>
                                            ...
                                            <form action="{{ route('albums.destroy', $album) }}" method="POST" class="float-left">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                                <button type="submit" onclick="return confirm('Jeste li sigurni da želite izbrisati  album {{$album->name}}?')" class="btn btn-danger">Izbriši Album</button>
                                            </form>
