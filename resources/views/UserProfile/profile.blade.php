                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="home">
                                                    ...
                                                    <form class="form" action="##" method="post" id="registrationForm">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-xs-6">
                                                                <label class="col-md-6 col-form-label text">Kupljeni albumi:</label><br>
                                                                @foreach($kupljeni as $kupljen)
                                                                        @if($user->id == $kupljen->user_id)


                                                                            @foreach($albumss as $al)
                                                                                 @if($al->id == $kupljen->album_id)


                                                                                <td> <a href="{{ url('kupljeni/' . $al->id) }}">  {{ $al->name }} </a></td>
